...
(function (O, U, s) {
    ...
    function Td() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = {"Content-Type": "admin/json;charset=utf-8"}, e = this.defaults = {
            ...
            headers: {common: {Accept: "admin/json, text/plain, */*"}, post: ba(d), put: ba(d), patch: ba(d)},
    ...
    function ze(b, a) {
        ...
        return {
            defer: e, reject: f, when: function (h, k, m, n) {
    ...
    q({
        data: jc, inheritedData: jb, scope: function (b) {
    ...
    q({
        removeData: hc, dealoc: Ha, on: function a(c, d, e, g) {
            ...
            c = (la(a, "events") || {})[c];
            d = d || [];
            var e = [{preventDefault: C, stopPropagation: C}];
            q(c, function (c) {
    ...
    var Qc = function (a) {
        ...
        Pe = /^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i, Qe = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Rc = {
            ...
            return {
                require: ["ngModel", "^?form"], controller: Re, link: function (a, c, d, e) {
                    var g = e[0], f = e[1] || sb;
                    f.$addControl(g);
