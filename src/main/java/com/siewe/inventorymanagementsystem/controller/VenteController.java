...
public class VenteController {
    ...
    public ResponseEntity<VenteDto> createVente(@Valid @RequestBody VenteDto venteDto) throws URISyntaxException {
        ...
        venteDto.setUserId(userRepository.findByEmail(SecurityUtils.getCurrentUserLogin()).getUserId());
    ...
    @GetMapping("/ventes-deleted-by-store/{storeId}")
    ...
    @GetMapping("/ventes-by-product/{storeId}")
    ...
    @GetMapping("/ventes-by-day/{storeId}")
    ...
    @GetMapping("/ventes-by-hour/{storeId}")
    ...
    @GetMapping("/ventes-by-seller/{storeId}")
    ...
    @RequestMapping(value="/ventes-export", method=RequestMethod.GET)
    ...
    @DeleteMapping("/ventes-confirm-delete/{id}")
    ...
    @GetMapping("/ventes-cancel-delete/{id}")
